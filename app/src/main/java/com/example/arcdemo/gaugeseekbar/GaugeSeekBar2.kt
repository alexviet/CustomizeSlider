...
import com.example.arcdemo.R

class GaugeSeekBar2 : View {
    ...
    private fun init(centerX: Float, centerY: Float) {
        ...
        if (showProgress) {
            progressDrawable = ProgressDrawable(centerPosition, progress, radiusPx, margin, progressGradientArray, startAngle, progressWidth)
        }
